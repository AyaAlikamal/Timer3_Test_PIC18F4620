...
timer3_object.timer3_mode = 0 ;
timer3_object.timer3_prescaller = 3;
timer3_object.timer3_register_wr_mode = 1 ;
Timer3_Init(&timer3_object);

}
void timer3_counter_init(){
counter3_object.TMR3_Interrupt_Hundeler = ((void*)0);
counter3_object.timer3_mode = (T3CONbits.TMR3CS = 1);
counter3_object.timer3_prescaller = 0;
counter3_object.timer3_preload_value =0 ;
counter3_object.timer3_register_wr_mode = 1 ;
counter3_object.timer3_counter_mode = 0;
